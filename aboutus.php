...
<html>
  ...
  <head>
    ...
    background-image: url('https://cfa.ca/wp-content/uploads/2020/03/4031.jpg');}
    h1 { color: green; }
    img { position: absolute; left: 300px; }
    </style> 
  </head>
...
?>
    ...
    <div class="wide">
        ...
        <br>
        <h3 style="color: black">Order your favourite food & beverages. <h3 style="color: black">We deliver delicious foods within 30 minutes.</h3><h3 style="color : white"> </h3><h3 style="color : black"> We place no minimum order restrictions! Order in as little (or as much) as you'd like. We'll Swiggy it to you!</h3></h3>
    </div>
